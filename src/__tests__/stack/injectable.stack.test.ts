...
describe("InjectableStack", () => {
    describe("constructor", () => {
        ...
        it("should initialize a new instance with a clone dependency injection", () => {
            const stack = new InjectableStack<{ names: string[] }>(
                [{ names: ["Alice"] }, { names: ["Bob"] }],
                (data) => data.map((element) => {
                    return { names: [...element.names] };
                })
            );

            expect(stack.count).toBe(2);
            expect(stack.toArray()).toEqual([{ names: ["Alice"] }, { names: ["Bob"] }]);
        });
    });
    ...
    describe("pop", () => {
        ...
        it("should remove multiple elements from the top of the stack", () => {
            const stack = new InjectableStack([1, 2, 3, 4]);
    ...
    describe("search", () => {
        it("returns empty array if no element matches the search function", () => {
            const stack = new InjectableStack<number>([1, 2, 3]);
        ...
        it("returns all elements that match the search function for an array of objects", () => {
            const stack = new InjectableStack<{ name: string; age: number }>([
                { name: "Alice", age: 25 },
                { name: "Bob", age: 30 },
                { name: "Charlie", age: 35 },
            ]);
    ...
    describe("isEmpty", () => {
        it("should return true when stack is empty", () => {
            const stack = new InjectableStack<number>();
    ...
    describe("moveDown", () => {
        ...
        it("should do nothing if the stack is empty", () => {
            const emptyStack = new InjectableStack<number>();
            emptyStack.moveDown();
    ...
    describe("rotate", () => {
        it("should rotate the stack with 2 elements", () => {
            const stack = new InjectableStack<number>([1, 2]);
            stack.rotate();
            expect(stack.pop()).toBe(1);
            expect(stack.pop()).toBe(2);
        });
        ...
        it("should rotate the stack with 4 elements", () => {
            const stack = new InjectableStack<number>([1, 2, 3, 4]);
            stack.rotate();
            expect(stack.pop()).toBe(1);
            expect(stack.pop()).toBe(2);
            expect(stack.pop()).toBe(3);
        ...
        it("should not change the stack with only one element", () => {
            const stack = new InjectableStack<number>([1]);
            stack.rotate();
    ...
    describe("swap", () => {
        ...
        it("should swap the top two elements without changing the reference", () => {
            const arr1 = [1];
            const arr2 = [2];
            const stack = new InjectableStack([arr1, arr2]);
            stack.swap();
    ...
    describe("any", () => {
        ...
        it("returns true when at least one element is truthy", () => {
            const stack = new InjectableStack<number>([0, 0, 0, 0, 1]);
            const result = stack.any();
            expect(result).toBe(true);
        });

        it("returns false when all elements are falsy", () => {
            const stack = new InjectableStack([0, null, false, undefined]);
            const result = stack.any();
            expect(result).toBe(false);
        });
    });
    ...
    describe("find", () => {
        it("should return the first element in the Stack where the predicate is true", () => {
            const stack = new InjectableStack<number>([1, 2, 3, 4, 5]);
    ...
    describe("shuffle", () => {
        it("should shuffle the elements in the stack", () => {
            const stack = new InjectableStack<number>([1, 2, 3, 4, 5, 6, 7, 8, 9]);
